...
const ExpertisesNumber2 = () => {
  return (
    <section className="pcsoft-section">
      <div className="pcsoft-container">
        <h3 className="pcsoft-title">1. LANGAGES DE PC SOFT</h3>

        <p className="pcsoft-subtitle">
          JM-Contacts : Votre Partenaire pour des Solutions Logicielles Dynamiques
        </p>
        ...
        <div className="pcsoft-description">
          ...
          <p>
            Nous avons  choisi d’utiliser les langages <strong>WinDev</strong>, <strong>WinDev Mobile</strong> et
